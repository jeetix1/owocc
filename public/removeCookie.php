...
// If the cookie count is not set or is less than 1, set it to 0
if (!isset($_SESSION['cookieCount']) || $_SESSION['cookieCount'] < 1) {
    $_SESSION['cookieCount'] = 0;
} else {
    // Decrement the cookie count and update the database
